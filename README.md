# Project 2 - *NYT Search App*

**NYT Search App** is an android app that allows a user to search for articles on web using simple filters. The app utilizes [New York Times Search API](http://developer.nytimes.com/docs/read/article_search_api_v2).
...
* [X] List anything else that you can get done to improve the app functionality!
    ...
    * [X] Added custom fonts
        * [X] Cheltenham, NYT's font; for text
        * [X] EnglishTowne for toolbar

## Video Walkthrough

Here's a walkthrough of implemented user stories:

<img src='./nyt2.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
